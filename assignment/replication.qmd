...
By Milestone 1, you should have identified the study you would like to replicate, and you should have sourced the necessary data.[^help] Also, you should have developed a good understanding of all the analyses in the original article and how the paper is able to make causal claims. 

[^help]: I provide resources on how to identify replication packages [here](/resource/data.qmd).
