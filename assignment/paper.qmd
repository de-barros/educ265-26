...
By Milestone 1, you should have identified the study you would like to conduct, and you should have sourced the necessary data to do so.[^help] Also, you should have developed a good understanding of what covariates you will need to have access to.  

[^help]: This data may come from one of your research projects. I provide additional resources on how to identify datasets [here](/resource/data.qmd).
